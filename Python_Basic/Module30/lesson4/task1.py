...
grades = [{'name': 'Kenneth', 'score': 3}, {'name': 'Bebe', 'score': 41}, {'name': 'Joyce', 'score': 24},
...
print(min(grades, key=lambda dict: dict.get('score')))
print(max(grades, key=lambda dict: dict.get('score')))